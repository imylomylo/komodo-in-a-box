...
--title "[ S T A R T E R - K I T - W A L L E T - C O N S O L E ]" \
...
SENDTOSELF "sendtoaddress - send some native $CHAIN coins to yourself" \
SENDALLTO "sendtoaddress - send all native $CHAIN coins to an address" \
