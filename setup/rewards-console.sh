...
UNLOCK "rewardsunlock - unlock funds in a reward plan on $CHAIN" \
Back "Back" 2>"${INPUT}"
...
function submenu_rewardsunlock {
    helper_rewardslist
    # get the array from ~/.kiabresponse
    # [
    #   "be75c48e0168668ef8a6861e51ba8461deb5a923bf50bd7e9a89917dfb066462",
    ...
    # echo $menuitem
    # echo $REWARDSTXID
    input_box "Unlock Query" "If you know the txid of when you locked funds enter it here?" "55" LOCKINGTXID
    rewardsunlock
    sleep 1
    done
}